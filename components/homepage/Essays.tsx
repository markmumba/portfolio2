...
const Essays = async () => {
    ...
    if (essays.length === 0) {
        return (
            <section id="essays" className="py-8 bg-newspaper-white border-t-4 border-black">
    ...
    return (
        <section id="essays" className="py-8 bg-newspaper-white border-t-4 border-black">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 text-center bg-gray-100 p-6 border-2 border-black">
                    <h3 className="text-lg font-newspaper font-bold text-black mb-3">
                        Have Thoughts to Share?
                    </h3>
                    <p className="text-newspaper-gray font-newspaper mb-4 text-sm">
                    ...
                    <Link
                        ...
                        className="inline-block bg-accent-red text-white px-6 py-2 text-base font-newspaper-sans hover:bg-red-700 transition-colors duration-200 border-2 border-accent-red ml-3"
                    >
                        Reach Out
                    </Link>
                </div>
